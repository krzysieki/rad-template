  ...
  ControlPanel.config([
    '$routeProvider', function($routeProvider) {
      $routeProvider.when('/dashboard', {
        templateUrl: '../assets/mainDashboard.html',
        controller: 'DashboardCtrl'
      });
      $routeProvider.when('/invoices', {
        templateUrl: '../assets/mainInvoices.html',
        controller: 'InvoiceCtrl'
      });
      $routeProvider.when('/ads', {
        templateUrl: '../assets/mainAds.html',
        controller: 'DashboardCtrl'
      });
      $routeProvider.when('/playlists', {
        templateUrl: '../assets/mainPlaylists.html',
        controller: 'PlaylistsCtrl'
      });
      $routeProvider.when('/playlists/:playlistId', {
        templateUrl: '../assets/editPlaylist.html',
        controller: 'PlaylistsCtrl'
      });
      $routeProvider.when('/devices', {
        templateUrl: '../assets/mainDevices.html',
        controller: 'DevicesCtrl'
      });
      $routeProvider.when('/devices/:deviceserial', {
        templateUrl: '../assets/mainDevice.html',
        controller: 'DevicesCtrl'
      });
      $routeProvider.when('/help', {
        templateUrl: '../assets/mainHelp.html',
        controller: 'DashboardCtrl'
      });
      $routeProvider.when('/adminDashboard', {
        templateUrl: '../assets/adminDashboard.html'
      });
      $routeProvider.when('/adminUsers', {
        templateUrl: '../assets/adminUsers.html',
        controller: 'usersCtrl'
      });
      $routeProvider.when('/adminDevices', {
        templateUrl: '../assets/adminDevices.html'
      });
      $routeProvider.when('/adminPlaylists', {
        templateUrl: '../assets/adminPlaylists.html'
      });
      $routeProvider.when('/adminInvoices', {
        templateUrl: '../assets/adminInvoices.html'
      });
...
(function() {
  angular.module('ControlPanel').factory('adsService', [
    '$http', function($http) {
      var adsService;
      adsService = {
        data: {
      ...
      adsService.loadAds = function(deferred) {
        if (!adsService.isLoaded) {
          return $http.get('./ads.json').success(function(data) {
      ...
      adsService.createAd = function(newAd) {
        ...
        $http.post('./ads.json', data).success(function(data) {
          console.log('Succesfully created ad.');
          return adsService.data.ads.push(data);
        }).error(function() {
          return console.error('Failed to create new ad');
        });
        return true;
      };
      return adsService;
...
(function() {
  angular.module('ControlPanel').factory('currentUser', [
    '$http', function($http) {
      var currentUser;
      currentUser = {
        data: {
      ...
      currentUser.loadUser = function() {
        if (!currentUser.isLoaded) {
          return $http.get('./users.json').success(function(data) {
            ...
            return currentUser.isLoaded = true;
          }).error(function() {
...
(function() {
  angular.module('ControlPanel').factory('deviceService', [
    '$http', function($http) {
      var deviceService;
      deviceService = {
        data: {
      ...
      deviceService.loadDevices = function(deferred) {
...
(function() {
  angular.module('ControlPanel').factory('invoiceService', [
    '$http', function($http) {
      var invoices;
      invoices = {
        invoices: [
...
(function() {
  angular.module('ControlPanel').factory('playlistService', [
    '$http', function($http) {
      var playlistService;
      playlistService = {
        data: {
      ...
      playlistService.loadPlaylists = function(deferred) {
      ...
      playlistService.deletePlaylist = function(playlistId) {
        console.log('Playlist with id ' + playlistId + ' is going to get deleted');
        return $http["delete"]('./playlists/' + playlistId + '.json').success(function() {
          return console.log('Deleted success!');
        }).error(function() {
          return console.log('Delete failed');
        });
      };
      playlistService.createPlaylist = function(newPlaylist) {
        var data;
        data = {
          new_playlist: {
        ...
        $http.post('./playlists.json', data).success(function(data) {
          console.log('Succesfully created playlist.');
          return playlistService.data.playlists.push(data);
        }).error(function() {
          return console.error('Failed to create new playlist');
        });
        return true;
      };
...
(function() {
  angular.module('ControlPanel').factory('usersService', [
    '$http', function($http) {
      var usersService;
      usersService = {
        data: {
      ...
      usersService.loadCurrentUser = function(deferred) {
      ...
      usersService.loadUsers = function(deferred) {
...
(function() {
  this.DashboardCtrl = function($scope, usersService, $q, $upload, $filter) {
    $scope.title = "Digital Ad Control Panel";
    $scope.currentUser = usersService.data.currentUser;
    $scope.bars = [];
    $scope.prepCurrentUser = function() {
      return $scope.currentUser = usersService.data.currentUser;
    };
    this.deferred = $q.defer();
    this.deferred.promise.then($scope.prepCurrentUser);
    usersService.loadCurrentUser(this.deferred);
    return $scope.onFileSelect = function($files) {
      var busy, file, i, myBar;
      i = 0;
  ...
  this.DashboardCtrl.$inject = ['$scope', 'usersService', '$q', '$upload', '$filter'];

}).call(this);
(function() {
  this.InvoiceCtrl = function($scope, invoiceService) {
...
(function() {
  this.ModalInstanceCtrl = function($scope, playlistsServ, $modalInstance) {
    $scope.edit = false;
    $scope.formData = {
      newPlaylistName: ''
    };
...
angular.module('adsCtrl', []);
(function() {
  this.DevicesCtrl = function($scope, $routeParams, deviceService, $q, $location) {
    $scope.data = {
    ...
    $scope.viewDevice = function(deviceId) {
      return $location.url('/devices/' + deviceId);
    };
    $scope.prepDevices = function() {
      var device;
      device = _.findWhere(deviceService.data.devices, {
        id: parseInt($scope.data.deviceId)
      });
      $scope.data.currentDevice = device;
      return $scope.data.devices = deviceService.data.devices;
    };
    this.deferred = $q.defer();
    this.deferred.promise.then($scope.prepDevices);
    return deviceService.loadDevices(this.deferred);
  };

}).call(this);
(function() {
  this.PlaylistsCtrl = function($scope, $routeParams, playlistService, $modal, $q, $location) {
    $scope.data = {
    ...
    $scope.editPlaylist = function(playlistId) {
      return $location.url('/playlists/' + playlistId);
    };
    $scope.destroyPlaylist = function(playlistId) {
      var playlist;
      playlist = _.findWhere(playlistService.data.playlists, {
      ...
      return $scope.data.playlists = playlistService.data.playlists;
    };
    $scope.prepPlaylists = function() {
      var playlist;
      playlist = _.findWhere(playlistService.data.playlists, {
        id: parseInt($scope.data.playlistId)
      });
      $scope.data.currentPlaylist = playlist;
      return $scope.data.playlists = playlistService.data.playlists;
    };
    this.deferred = $q.defer();
    this.deferred.promise.then($scope.prepPlaylists);
    return playlistService.loadPlaylists(this.deferred);
  };

}).call(this);
(function() {
  this.usersCtrl = function($scope, usersService, $q) {
    $scope.currentUser = usersService.data.currentUser;
    $scope.users = usersService.data.users;
    usersService.loadUsers();
    $scope.prepUsers = function() {
      return $scope.users = usersService.data.users;
    };
    this.deferred = $q.defer();
    this.deferred.promise.then($scope.prepUsers);
    return usersService.loadUsers(this.deferred);
  };
